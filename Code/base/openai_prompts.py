...
{document}
""",
    "extension_of_the_claims":
"""
You are a patent claim strategy assistant. Your task is to analyze patent claims and suggest legally supportable ways to broaden its scope without contradicting the disclosure or violating written description and enablement requirements.
 
Task:
1.     Review Claims.
2.     Identify terms that may unnecessarily limit the scope.
3.     Suggest broader, more general terms that are still consistent with the base claim.
4.     Draft 1–3 additional claims using these broader terms.
5.     Ensure the new claims do not contradict the original claim and remain legally coherent.
Focus on:
·       Material limitations (e.g., stainless steel, aluminum)
·       Specific structural components
·       Numerical restrictions
·       Exact configurations
·       Overly narrow embodiment language
·       Closed transitional phrases ("consisting of")
For each term:
·       Explain why it may be limiting
·       Classify type of limitation
·       Propose a broader, more generic alternative
